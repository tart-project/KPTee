...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"importCardsInfo\", function() { return importCardsInfo; });\n/* harmony import */ var _card__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./card */ \"./src/card.js\");\n/* harmony import */ var _card_const__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./card-const */ \"./src/card-const.js\");\n/* harmony import */ var _file_handler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./file-handler */ \"./src/file-handler.js\");\n\r\n\r\n\r\n\r\n// html上の関数と紐づけ\r\nwindow.createCard = createCard\r\nwindow.changeCardColor = _card__WEBPACK_IMPORTED_MODULE_0__[\"changeCardColor\"]\r\nwindow.importCardsInfo = importCardsInfo\r\nwindow.exportCardsInfo = exportCardsInfo\r\n\r\n// グローバル変数設定\r\nconst cardsList = [];\r\n\r\n// カード作成関数\r\nfunction createCard() {\r\n\r\n    // カードの生成\r\n    const card = new _card__WEBPACK_IMPORTED_MODULE_0__[\"default\"](_card_const__WEBPACK_IMPORTED_MODULE_1__[\"defaultCardInfo\"])\r\n\r\n    // カードリストにidを追加\r\n    cardsList.push(card)\r\n}\r\n\r\n// インポート関数\r\nfunction importCardsInfo(e) {\r\n\r\n    if (e) {\r\n        // ファイルが読み込まれた場合→ファイル情報からカードを生成\r\n        const importedCards = Object(_file_handler__WEBPACK_IMPORTED_MODULE_2__[\"createCardsFromFile\"])(e.target.files[0])\r\n\r\n        // カードリストにidを追加\r\n        cardsList.concat(importedCards)\r\n    }\r\n}\r\n\r\n// エクスポート関数\r\nfunction exportCardsInfo() {\r\n\r\n    // カード情報一覧からファイル作成\r\n    const exportedFile = Object(_file_handler__WEBPACK_IMPORTED_MODULE_2__[\"createFileFromCards\"])(cardsList)\r\n\r\n    //ファイルをダウンロード\r\n    Object(_file_handler__WEBPACK_IMPORTED_MODULE_2__[\"downloadFile\"])(exportedFile)\r\n}\n\n//# sourceURL=webpack:///./src/index.js?");
